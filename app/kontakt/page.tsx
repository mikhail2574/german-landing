  ...
  return (
    <main className="mx-auto max-w-3xl px-5 py-12 sm:px-8">
      ...
      <p className="mt-4 text-slate-600">
        Office in Leipzig + online по всiй Нiмеччинi.
      </p>
      ...
      <section className="mt-8 grid gap-4 sm:grid-cols-2">
        <article className="rounded-2xl border border-blue-100 bg-white p-5 shadow-sm">
          ...
          <a
            href="mailto:info@deutschfuerleben.de"
            className="mt-2 block font-medium text-slate-900"
          >
      ...
      <section className="mt-4 rounded-2xl border border-blue-100 bg-white p-5 shadow-sm">
        ...
        <p className="mt-2 font-medium text-slate-900">
          Leipzig (центр) · online по Нiмеччинi
        </p>
      </section>
      ...
      <section className="mt-4 rounded-2xl border border-amber-200 bg-amber-50 p-5 shadow-sm">
        ...
        <p className="mt-2 font-semibold text-amber-950">Протягом 24 годин</p>
      </section>
    </main>
  );
}
