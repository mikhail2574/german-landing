  ...
  ua: {
    ...
    hero: {
      ...
      variants: {
        a: {
          title:
            "Важко інтегруватися без мови? Доведемо з нуля до B1 для життя, роботи і DTZ",
          subtitle:
        ...
        b: {
          title:
            "Переїхали в Німеччину і мова гальмує документи та роботу? Підготуємо до B1 і DTZ",
          subtitle:
    ...
    howItWorks: {
      ...
      subtitle:
        "Один процес, який веде від першого уроку до впевненого спілкування.",
      cards: [
        {
          icon: "route",
    ...
    program: {
      ...
      lessonFlow: [
        {
          time: "0-15 хв",
          text: "Розігрів і повтор активних фраз минулого уроку.",
        },
        {
          time: "15-45 хв",
          text: "Нова тема на реальному сценарії з Німеччини.",
        },
        { time: "45-70 хв", text: "Рольові діалоги в парах і малій групі." },
        {
          time: "70-90 хв",
          text: "Розбір помилок, фрази-шаблони та домашній план.",
        },
      ],
    ...
    founder: {
      label: "Хто веде курс",
      title: "Своя людина у Німеччині: практично, без академічної води",
      profileName: "Михайло, засновник Deutsch fur Leben",
      profileRole: "Викладач німецької та куратор інтеграційних груп",
      trustLine: "Office in Leipzig • Online по всій Німеччині",
      text: "Я пройшла шлях інтеграції в Німеччині разом зі студентами: від першого Termin до впевнених розмов на роботі. Курс створений так, щоб мова одразу працювала в реальному житті.",
      bullets: [
        {
    ...
    leadMagnet: {
      ...
      success:
        "Готово. Ми надішлемо чеклист на e-mail. Якщо хочете — залиште заявку на групу.",
    ...
    form: {
      ...
      subtitle:
        "Залиште контакт, і ми підберемо найкращий потік під ваш графік.",
      ...
      privacy:
        "Використовуємо дані лише для відповіді на заявку і підбору групи.",
      ...
      successText:
        "Напишемо вам протягом 24 годин з рекомендованою групою та наступним кроком.",
  ...
  ru: {
    ...
    hero: {
      ...
      variants: {
        a: {
          title:
            "Трудно интегрироваться без языка? Доведем с нуля до B1 для жизни, работы и DTZ",
          subtitle:
        ...
        b: {
          title:
            "Переехали в Германию и язык тормозит документы и работу? Подготовим до B1 и DTZ",
          subtitle:
    ...
    program: {
      ...
      lessonFlow: [
        {
          time: "0-15 мин",
          text: "Разогрев и повтор активных фраз прошлого урока.",
        },
        {
          time: "15-45 мин",
          text: "Новая тема на живом сценарии из немецкой реальности.",
        },
        { time: "45-70 мин", text: "Ролевые диалоги в парах и мини-группах." },
        {
          time: "70-90 мин",
          text: "Разбор ошибок, шаблоны фраз и домашний план.",
        },
      ],
    ...
    founder: {
      ...
      text: "Я веду студентов через реальные этапы интеграции: от первых звонков и писем до уверенной коммуникации на работе. Курс создан так, чтобы язык сразу применялся в жизни.",
      bullets: [
        {
    ...
    leadMagnet: {
      ...
      pdfName: "checklist-jobcenter-dfl.pdf",
      success:
        "Готово. Мы отправим чеклист на e-mail. Если хотите — оставьте заявку на группу.",
    ...
    form: {
      ...
      privacy:
        "Используем данные только для ответа на заявку и подбора группы.",
      ...
      successText:
        "Напишем вам в течение 24 часов с рекомендованной группой и следующим шагом.",
